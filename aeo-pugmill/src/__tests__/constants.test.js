...
describe( 'IS_AI_MODE', () => {
	it( 'is false when window.aeopugmill is not set (defaults to free mode)', () => {
		// window.aeopugmill is undefined in test env; mode defaults to 'free'
...
describe( 'HAS_API_KEY', () => {
	it( 'is false when window.aeopugmill is not set (no API key configured)', () => {
