			...
			{ schemaType === 'HowTo' && (
				<>
					...
					<Button
						...
						disabled={ ! IS_AI_MODE || howtoState.loading }
						onClick={ async () => {
							...
							try {
								const res  = await fetch( ajaxUrl, {
									...
									body:    new URLSearchParams( { action: 'aeopugmill_generate_howto_steps', nonce: howtoNonce, post_id: postId } ),
								} );
						...
						style={ { width: '100%', justifyContent: 'center', marginTop: '4px', ...BUTTON_STYLE, ...( ! IS_AI_MODE ? { opacity: 0.4 } : {} ) } }
					>
