<?php
/**
 * WP Pugmill — AI utility functions (pure helpers, no side effects).
 *
 ...
 */
function wppugmill_get_paragraph_block_texts( $post_content ) {
 ...
 */
function wppugmill_remap_passage_to_raw( $passage, $raw_content ) {
