<?php
/**
 * WP Pugmill — Distribution AI AJAX handlers.
 *
 * Content distribution features:
 *   - wppugmill_ajax_generate_excerpt() — 1-2 sentence post excerpt
 *   - wppugmill_ajax_internal_links()   — internal linking suggestions
 *   - wppugmill_ajax_social_draft()     — social media post draft (LinkedIn/X/Facebook/Substack)
 *
